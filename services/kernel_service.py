...
class kernel_service:
    def __init__(self):
        ...
        g.logger.info("Initializing Semantic Kernel==0.5.1.dev0")
        self.kernel = sk.Kernel()

        deployment, api_key, endpoint  = sk.azure_openai_settings_from_dot_env()
        self.kernel.add_chat_service("ChatBot-Rag", AzureChatCompletion(deployment_name=deployment, api_key=api_key, base_url=f"{endpoint}openai/"))    
    ...
    def load_plugins(self):
        # Load the plugins       
        g.logger.info("Loading Semantic and Native Plugins...")
